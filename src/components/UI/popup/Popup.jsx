...
const Popup = ({setPopupActive, isPopupActive, textParagraph, usePesronalData, formId}) => {
    return (
        <div className={styles.popup}>
            ...
            <FormToOrder formId={formId} formStyle={styles.form} usePesronalData={usePesronalData}/>
        </div> 
    )
