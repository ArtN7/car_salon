    ...
    return (
        <div className={styles.container}>
            <div className={styles.map}>
                <iframe src="https://yandex.ru/map-widget/v1/?indoorLevel=1&ll=38.979401%2C45.044792&mode=search&ol=geo&ouri=ymapsbm1%3A%2F%2Fgeo%3Fdata%3DCgg1NjM5ODQ4MxJC0KDQvtGB0YHQuNGPLCDQmtGA0LDRgdC90L7QtNCw0YAsINCa0YDQsNGB0L3QsNGPINGD0LvQuNGG0LAsIDE3Ni8xIgoNNeobQhUBLjRC&z=17.29" allowfullscreen="true" className={styles.frameMap}></iframe>
            </div>
