...
<p>P.S. На данный момент работаю с совместной работой фильтрации, поиска и сортировки. Хочу, чтобы при фильтрации, и последующем поики отображалиь автомобили, удовлетворяющие обоим. Пока работает не корректно</p>